...
# Use 1 or all phrase
__C.TRAIN.USE_ONE_PHRASE = False
__C.TRAIN.USE_REGULARIZATION = False
...
__C.PIXEL_MEANS = np.array([[[102.9801, 115.9465, 122.7717]]])  # no effect at all!
#__C.PIXEL_MEANS = np.array([[[0.0, 0.0, 0.0]]])  ## debug mode
